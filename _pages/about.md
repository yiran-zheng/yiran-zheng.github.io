...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px; background-color: white; border: 1px solid white; border-radius: 10px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
  <div style="flex: 1.5; margin-right: 20px; align-self: center;">
    <div style="flex: 2;font-size: 18px;color: #666666;">
      <p>
      I am a Ph.D. candidate in the Department of Economics at Texas Tech University.   
      </p>
      <p>
      I am on job market for the 2024-2025 academic year.
      </p>
      <p>
      My primary research interests are in industrial organization and applied microeconomics, concentrating on choice behavior, marketing, and the accommodation industry.
      </p>
    </div>
  </div>
</div>
